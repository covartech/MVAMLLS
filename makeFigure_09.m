...
subplot(2,2,3); plot(retainFeatures(rt(prtPreProcAbsSumNormalizeRows,ds),1:3)); 
...
subplot(2,2,4); plot(retainFeatures(rt(prtPreProcMinMaxRows,ds),1:3)); 
title('Min/Max Norm'); 
grid on;
xlabel('');
ylabel(''); 
...
% s2({'png','fig'},'libsChapter_Fig09_PreProc');